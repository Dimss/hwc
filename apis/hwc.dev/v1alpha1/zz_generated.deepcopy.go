...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HellowWorldStatus) DeepCopyInto(out *HellowWorldStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HellowWorldStatus.
func (in *HellowWorldStatus) DeepCopy() *HellowWorldStatus {
	if in == nil {
		return nil
	}
	out := new(HellowWorldStatus)
	in.DeepCopyInto(out)
	return out
}
